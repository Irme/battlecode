...
public class HQBehavior {
	...
	static int pastrHealth1 = 200;
	static int pastrHealth2 = 200;
	/** debugging constant **/
	...
	public static void broadcastPath(MapLocation[] path){
	...
	public static void buildOpponentModel(RobotRepresentation [] bots, RobotController rc) throws Exception{
		...
		int phealth1 = rc.readBroadcast(StaticVariables.ROBOT_PASTR_ONE_CHANNEL);
		int phealth2 = rc.readBroadcast(StaticVariables.ROBOT_PASTR_ONE_CHANNEL);
		if (phealth1 != 0 && phealth1 < pastrHealth1){
			opponentModel =+ 0.005;
		}else if(phealth1 >= pastrHealth1){
			opponentModel =- 0.005;
		}

		if (phealth2 != 0 && phealth2 < pastrHealth1){
			opponentModel =+ 0.005;
		}else if(phealth2 >= pastrHealth1){
			opponentModel =- 0.005;
		}
