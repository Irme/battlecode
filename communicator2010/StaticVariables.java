...
public class StaticVariables {
	...
	public static final int GROUP_CHANNEL_LENGTH_PER_GROUP = 100;
	
	/** This variable is a threshold. If the health of a soldier drops below this value, the soldier goes into the fleeing mode.**/
	public static final int ROBOT_FLEEING_HEALTH_THRESHOLD = 0;
	public static final int ROBOT_BACKUP_HEALTH_THRESHOLD = 50;
	public static final int ROBOT_RETREATING_HEALTH_THRESHOLD = 20;
	...
	public static final int COMMAND_FOLLOW_PATH = 9;
	...
	public static final double MULTIPLICATOR_GROUP_POWER = 1.3;
	...
	public static final double VERSION_NUMBER = 2.009d;
}
